...
const appRoutes: Routes = [
  {path:'funcionalidades',component:FuncionalidadesComponent, ...canActivate(()=>redirectUnauthorizedTo(['']))},
  {path:'',component:IngresarComponent},
  {path:'registrar',component:RegistrarComponent},
  {path:'contenidos8vo',component:Contenidos8voComponent, ...canActivate(()=>redirectUnauthorizedTo(['']))},
  {path:'ejercitar8vo',component:Ejercitar8voComponent, ...canActivate(()=>redirectUnauthorizedTo(['']))},
  {path:'puduebas8vo',component:Puduebas8voComponent, ...canActivate(()=>redirectUnauthorizedTo(['']))},
  {path:'contenidos8voU1',component:Contenido8voU1Component, ...canActivate(()=>redirectUnauthorizedTo(['']))},
  {path:'contenidos8voU2',component:Contenido8voU2Component, ...canActivate(()=>redirectUnauthorizedTo(['']))},
  {path:'contenidos8voU3',component:Contenido8voU3Component, ...canActivate(()=>redirectUnauthorizedTo(['']))},
  {path:'contenidos8voU4',component:Contenido8voU4Component, ...canActivate(()=>redirectUnauthorizedTo(['']))},
  {path:'ejercitar8voU1',component:Ejercitar8voU1Component, ...canActivate(()=>redirectUnauthorizedTo(['']))},
  {path:'ejercitar8voU2',component:Ejercitar8voU2Component, ...canActivate(()=>redirectUnauthorizedTo(['']))},
  {path:'ejercitar8voU3',component:Ejercitar8voU3Component, ...canActivate(()=>redirectUnauthorizedTo(['']))},
  {path:'ejercitar8voU4',component:Ejercitar8voU4Component, ...canActivate(()=>redirectUnauthorizedTo(['']))},
  {path:'puduebas8voU1',component:Puduebas8voU1Component, ...canActivate(()=>redirectUnauthorizedTo(['']))},
  {path:'puduebas8voU2',component:Puduebas8voU2Component, ...canActivate(()=>redirectUnauthorizedTo(['']))},
  {path:'puduebas8voU3',component:Puduebas8voU3Component, ...canActivate(()=>redirectUnauthorizedTo(['']))},
  {path:'puduebas8voU4',component:Puduebas8voU4Component, ...canActivate(()=>redirectUnauthorizedTo(['']))},
  {path:'agregar-pregunta',component:AgregarPreguntaComponent, ...canActivate(()=>redirectUnauthorizedTo(['']))},
